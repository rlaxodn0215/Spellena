...
public class SelectingCharacter : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        selectEffects = Helper.FindObjects(gameObject, "SelectEffect");
    }
    void ConnectUI()
    {
        UIObjects["timeCount"] = Helper.FindObject(gameObject, "TimeCount");
    ...
    public void ConfirmCharacter()
    {
        ...
        Helper.ChangePlayerCustomProperties(PhotonNetwork.LocalPlayer, "Character", selectName);
